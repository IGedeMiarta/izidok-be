								...
								<div class="col num12"
									...
									<div style="width:100% !important;">
										...
										<div
											...
											<div align="center">
												<a href="http://api.izidok.id/api/v1/image?path=logo/Logo-izidok-blue.png"><img width="50%"
														style="padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;"
														src="http://api.izidok.id/api/v1/image?path=logo/Logo-izidok-blue.png" alt="logo-izidok"
														border="0" /></a>
											</div>
