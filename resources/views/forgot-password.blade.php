		...
		<tbody>
			<tr style="vertical-align: top;" valign="top">
				<td style="word-break: break-word; vertical-align: top;" valign="top">
					...
					<div style="background-color:transparent;">
						<div class="block-grid"
							style="Margin: 0 auto; min-width: 320px; max-width: 600px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; background-color: #F6F6F6;">
								...
								<div class="col num12"
									...
									<div style="width:100% !important;">
										...
										<div
											...
											<div align="center">
												<a href="https://api.izidok.id/api/v1/image?path=logo/Logo-izidok-blue.png"><img width="50%"
														style="padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;"
														src="https://api.izidok.id/api/v1/image?path=logo/Logo-izidok-blue.png" alt="logo-izidok"
														border="0" /></a>
											</div>
										...
										<div
											...
											<div align="center" class="button-container"
												...
												<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{@$activation_url}}" style="height:31.5pt; width:382.5pt; v-text-anchor:middle;" arcsize="10%" stroke="false" fillcolor="#3AAEE0"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:Arial, sans-serif; font-size:16px"><![endif]--><a
													href="{{@$activation_url}}"
													style="-webkit-text-size-adjust: none; text-decoration: none; display: block; color: #ffffff; background-color: #3AAEE0; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; width: 100%; width: calc(100% - 2px); border-top: 1px solid #3AAEE0; border-right: 1px solid #3AAEE0; border-bottom: 1px solid #3AAEE0; border-left: 1px solid #3AAEE0; padding-top: 5px; padding-bottom: 5px; font-family: 'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif; text-align: center; mso-border-alt: none; word-break: keep-all;"
													target="_blank"><span
											...
											<div
												...
												<div
													style="font-family: 'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 12px; line-height: 1.2; color: #555555; mso-line-height-alt: 14px;">
													<p
														style="font-size: 14px; line-height: 1.2; mso-line-height-alt: 17px; margin: 0;">
														<span style="color: #333333; font-size: 14px;">Jika anda
													...
													<p
														style="font-size: 14px; line-height: 1.2; mso-line-height-alt: 17px; margin: 0;">
														<span
															style="color: #0000ff; font-size: 14px;">{{@$activation_url}}</span>
													</p>
													<p
														style="font-size: 14px; line-height: 1.2; mso-line-height-alt: 17px; margin: 0;">
														 </p>
													...
													<p
														style="font-size: 14px; line-height: 1.2; mso-line-height-alt: 17px; margin: 0;">
														<span style="color: #333333; font-size: 14px;">Terima
															Kasih,</span></p>
													<p
														style="font-size: 14px; line-height: 1.2; mso-line-height-alt: 17px; margin: 0;">
														 </p>
													...
													<p
														style="font-size: 14px; line-height: 1.2; mso-line-height-alt: 17px; margin: 0;">
														<span style="color: #333333; font-size: 14px;">Izidok
															Team</span></p>
												</div>
											</div>
											<!--[if mso]></td></tr></table><![endif]-->
