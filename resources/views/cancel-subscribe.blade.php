...
<p>&nbsp;</p>
<!-- [if !mso]><!--><!--<![endif]--><!-- [if !mso]><!--><!--<![endif]--><!-- [if IE]><div class="ie-browser"><![endif]-->
...
<p style="font-size: 22px; line-height: 1.2; mso-line-height-alt: 26px; margin: 0;"><span style="font-size: 22px;">Pembayaran melalui {{$data['pg']->nama}} dibatalkan</span></p>
</div>
</div>
...
<p style="font-size: 14px; line-height: 1.5; mso-line-height-alt: 21px; margin: 0;">Pembayaran Anda telah dibatalkan</p>
<p style="font-size: 14px; line-height: 1.5; mso-line-height-alt: 21px; margin: 0;">&nbsp;</p>
<p style="font-size: 14px; line-height: 1.5; mso-line-height-alt: 21px; margin: 0;">Mohon untuk tidak membayar pembelian ini</p>
<p style="font-size: 14px; line-height: 1.5; mso-line-height-alt: 21px; margin: 0;">&nbsp;</p>
<table style="width: 103.427%;">
<tbody>
<tr>
<td style="width: 44.4118%;">Total Pembayaran</td>
<td style="width: 56.5882%;">Batas Waktu Pembayaran</td>
</tr>
<tr>
<td style="width: 44.4118%;">{{number_format($data['pl']->transactionAmount,0,',','.')}},-</td>
<td style="width: 56.5882%;">{{$data['pl']->transactionExpire}}</td>
</tr>
<tr>
...
<tr>
<td style="width: 44.4118%;">{{$data['pg']->nama}}</td>
<td style="width: 56.5882%;">{{$data['pl']->customerAccount}}</td>
</tr>
</tbody>
</table>
<p>&nbsp;</p>
<p style="font-size: 14px; line-height: 1.2; mso-line-height-alt: 17px; margin: 0;">Keterangan</p>
<table style="width: 511px; border: 1px red solid;">
<tbody>
<tr>
<td style="width: 513px;">Pembayaran dibatalkan oleh {{$data['user']}} pada tanggal {{$data['now']}}</td>
</tr>
</tbody>
</table>
</div>
...
<div style="font-family: 'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 12px; line-height: 1.2; color: #555555; mso-line-height-alt: 14px;"><hr />
<p style="font-size: 14px; line-height: 1.2; mso-line-height-alt: 17px; margin: 0;"><strong>Detail Pemesanan:</strong></p>
<?php 
	$total = $data['paket']->harga+(!is_null($data['addson']) ? $data['addson']->harga : 0)+$data['pg']->biaya_admin;
?>
<table style="width: 100%;">
<tbody>
<tr>
<td style="width: 237px;" colspan="2">No. Tagihan: {{$data['pl']->transactionNo}}</td>
</tr>
<tr>
<td style="width: 237px;">Paket {{$data['paket']->nama}}</td>
<td style="width: 279px;">Rp{{$data['paket']->harga}}</td>
</tr>
@if(!is_null($data['addson']))
<tr>
<td style="width: 237px;">Paket {{$data['addson']}}</td>
<td style="width: 279px;">Rp{{$data['addson']->harga}}</td>
</tr>
@endif
<tr>
<td style="width: 237px;">admin</td>
<td style="width: 279px;">Rp{{$data['pg']->biaya_admin}}</td>
</tr>
</tbody>
</table>
<hr />
