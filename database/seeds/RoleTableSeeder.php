...
class RoleTableSeeder extends Seeder
{
    ...
    public function run()
    {
    	...
    	$data_role = array(
    		...
    		array('id'=>'3', 'role'=> 'klinik_admin','created_at'=>date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')),
    		array('id'=>'4', 'role'=> 'klinik_operator','created_at'=>date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')),
