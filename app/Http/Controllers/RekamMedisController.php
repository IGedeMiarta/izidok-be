...
class RekamMedisController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $trans_klinik->tgl_next_konsultasi = $request->tgl_next_konsultasi == 1 ? null : date('Y-m-d', strtotime($request->tgl_next_konsultasi)); //1 = tidak memilih jadwal next konsultasi
        $trans_klinik->save();
