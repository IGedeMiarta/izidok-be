...
class PasienController extends Controller
{
	...
	public function index(Request $request)
	{
		...
		$pasien = Pasien::select('id', DB::raw("CONCAT(nama,' (',DATE_FORMAT(tanggal_lahir, '%d-%m-%Y'),')') as nama"), DB::raw("DATE_FORMAT(tanggal_lahir, '%d-%m-%Y') AS tanggal_lahir"), 'nomor_rekam_medis', 'jenis_kelamin', 'nomor_hp', 'klinik_id', 'tensi_sistole', 'tensi_diastole', 'nadi', 'suhu', 'tinggi_badan', 'berat_badan')
